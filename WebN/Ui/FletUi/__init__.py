...
# from WebN.Utils.Search import on_search_query_changed
#
# #TODO:  Separate the user interface and queries for news retrieval methods.
#
# top_headlines = []
#
#
...
#     top_headlines_list_show = ft.ListTile(title=ft.Text(top_headlines[]), on_click=None, data=top_headlines)
#
#     # for i in range(10)
#     # Start search box
#     def close_anchor(e):
...
#
#     def handle_change(e):
#         on_search_query_changed(e.data)
