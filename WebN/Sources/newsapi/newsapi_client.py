...
from WebN.Sources.newsapi import Const as const
from WebN.Sources.newsapi.newsapi_auth import NewsApiAuth
from WebN.Sources.newsapi.newwsapi_exception import NewsAPIException
from WebN.Sources.newsapi.utils import (
...
class NewsApiClient(object):
    ...
    def get_top_headlines(  # noqa: C901
            self, q=None, qintitle=None, sources=None, language=None, country=None, category=None, page_size=None,
            page=None
    ):
